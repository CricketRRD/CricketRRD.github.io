...
The collector runs from <tt>cron</tt> every 5
minutes (or at a different rate, if you want), and
stores data into a data structure managed by
...
tree expresses everything Cricket needs to know about the types
of data to be collected, how to get it, and from which targets it
should collect data. The config tree is designed to minimize
...
WebTV Networks, Inc.</a> It was subsequently publically released
under the
<a href="license.php">GNU General Public License</a>. Without
the full support of WebTV's management, Cricket would still be an
...
SourceForge</a>. Cricket's
<a href="http://sourceforge.net/project/?group_id=1210">project page</a>
shows all the nifty services that we get for free from
the SourceForge guys. Thanks a bunch for your support.

<!-- we fetch the image locally, since the PHP one is slow, but we
	follow the rules and fetch the PHP one too. -->

<p align=center>
<A href="http://sourceforge.net">
<IMG src="img/sf.gif" width="88" height="31" border="0"></A>
<br>
