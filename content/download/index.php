    ...
    <div>
      ...
      <p>
        For the truly impatient, you can get <a
          title="Download Cricket 1.0.5"
          href="http://prdownloads.sf.net/cricket/cricket-1.0.5.tar.gz"
        >Cricket 1.0.5</a>, the latest production release, from
        <a href="http://sf.net/">SourceForge.Net</a>'s download server.
      </p>
      <p>
        All final releases of Cricket are available on the
        <a href="http://prdownloads.sf.net/cricket/">Sourceforge
          download server</a>.
      </p>
    </div>
    <div>
